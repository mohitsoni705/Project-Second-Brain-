...
export const Card = ({title,link , type , contentId}:CardProps) =>{
    ...
    return <div>
        <div className="p-8 bg-white rounded-md border border-gray-200 max-w-72 min-h-48 min-w- ">
            <div className="flex justify-between">
                ...
                <div className="pr-2 text-gray-500 cursor-pointer" onClick={handleDeletePostButton}>
                    <DeleteIcon />
                </div>
                </div>
            </div>
